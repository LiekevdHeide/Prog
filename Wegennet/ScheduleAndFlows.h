...
public:
	...
	std::vector<std::vector<size_t>> y;//time, activities planned (binary)
	...
	ScheduleAndFlows(size_t T, size_t vertices, size_t M, size_t ODpairs, std::vector<size_t> &numberODpaths);
